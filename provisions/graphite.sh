...
cp /tmp/files/graphite-local_settings.py /etc/graphite/local_settings.py
...
cp /tmp/files/carbon.conf /etc/carbon/carbon.conf

echo 'configure /etc/carbon/storage-schemas.conf'
cp /tmp/files/storage-schemas.conf /etc/carbon/storage-schemas.conf

echo 'configure /etc/carbon/storage-aggregation.conf'
cp /tmp/files/storage-aggregation.conf /etc/carbon/storage-aggregation.conf

cp /tmp/files/apache2.conf /etc/apache2/sites-enabled/graphite.conf
